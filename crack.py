...
\033[1;92m ═════════════════════════════   \033[1;91m
\033[1;96mAuthor   : DWT Crack
\033[1;96mYoutube  : DWT Crack
"""
...
def pilih_masuk():
	msuk = raw_input("\033[1;93mBY DWT Crack \033[91m:\033[1;96m ")
	if msuk =="":
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://www.youtube.com/channel/UCLWNvbrMwxS1eXaChUTI4nA ')
		bot_komen()
	except KeyError:
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93mDWT Crack \033[91m:\033[1;96m ")
	if unikers =="":
...
#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93mDWT Crack \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
